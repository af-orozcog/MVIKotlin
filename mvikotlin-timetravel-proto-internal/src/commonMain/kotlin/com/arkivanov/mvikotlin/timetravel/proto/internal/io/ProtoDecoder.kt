...
import com.arkivanov.mvikotlin.timetravel.proto.internal.data.timetravelfunctionlist.readTimeTravelFunctionList
...
class ProtoDecoder {
    ...
    fun decode(data: ByteArray): ProtoObject {
        ...
        return when (reader.readEnum<ProtoObjectType>()) {
            ...
            ProtoObjectType.TIME_TRAVEL_FUNCTION_LIST -> reader.readTimeTravelFunctionList()
        }
    }
}
